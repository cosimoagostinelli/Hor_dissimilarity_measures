...
- Notebooks 1-5 provide the results presented in the paper; notebook 6 produces the figures and the values of the Rand and Dunn indices.

The ``results" folder contains the results of the analysis used to create the figures.


If you use this code, please cite the corresponding paper (https://doi.org/10.1093/comnet/cnaf048).
